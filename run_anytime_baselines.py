...
from models import ConvBackboneCIFAR, ConvWrapper
...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="mnist",
                        choices=["mnist", "fashion_mnist", "emnist_letters", "cifar10", "svhn"])
    ...
    is_cifar = (args.dataset in ("cifar10", "svhn"))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_loss, train_ce, train_acc = train_one_epoch(
            ...
            max_grad_norm=args.max_grad_norm, is_cifar=use_conv_input
        )
        epoch_time = time.time() - t0

        test_acc = evaluate_fixed(model, test_loader, device, args.dataset, is_cifar=use_conv_input)
    ...
    anytime_results = evaluate_anytime_model(
        ...
        dataset_name=args.dataset, is_cifar=use_conv_input
    )
